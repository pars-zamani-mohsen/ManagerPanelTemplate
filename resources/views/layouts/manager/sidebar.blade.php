    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @php $moduleModel = '\App\Blog'; $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                @if((Auth::user()->isAbleTo(['show-' . $moduleModel::$modulename['model']]))  || Auth::user()->hasRole(\App\Http\Controllers\DashboardController::getOwnerRole()))
                    <li class="sidebar-item" data-url="{{ $url }}">
                        <a href="{{ url($url) }}" class='sidebar-link'>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        ...
                        @php  $moduleModel = '\App\Role';  $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                        @if((Auth::user()->isAbleTo(['show-' . $moduleModel::$modulename['model']]))  || Auth::user()->hasRole(\App\Http\Controllers\DashboardController::getOwnerRole()))
                            <li class="submenu-item" data-url="{{ $url }}">
                                <a href="{{ url($url) }}">
                        ...
                        @php  $moduleModel = '\App\Permission';  $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                        @if((Auth::user()->isAbleTo(['show-' . $moduleModel::$modulename['model']]))  || Auth::user()->hasRole(\App\Http\Controllers\DashboardController::getOwnerRole()))
                            <li class="submenu-item" data-url="{{ $url }}">
                                <a href="{{ url($url) }}">
                        ...
                        @php  $moduleModel = '\App\PermissionToRole';  $url = '/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $moduleModel::$modulename['en']; @endphp
                        @if((Auth::user()->isAbleTo(['show-' . $moduleModel::$modulename['model']]))  || Auth::user()->hasRole(\App\Http\Controllers\DashboardController::getOwnerRole()))
                            <li class="submenu-item" data-url="{{ $url }}">
                                <a href="{{ url($url) }}">
                                    <i class="bi bi-key"></i>
