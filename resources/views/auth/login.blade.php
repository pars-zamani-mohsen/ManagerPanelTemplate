...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group position-relative has-icon-left mb-4">
            ...
            <input type="text" name="mobile" class="form-control form-control-xl @error('mobile') is-invalid @enderror" placeholder="شماره تلفن همراه" value="{{ old('mobile') }}" required autofocus>
            @error('mobile')
