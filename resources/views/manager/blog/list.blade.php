        ...
        @if(count($all))
            @foreach ($all as $key => $item)
                <tr>
                    ...
                    <td>@if($item['country']['id'])<a href="{{ url('/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/country/' . $item['country']['id'] .'/edit') }}" target="_blank">#{{ $item['country']['id'] }}-{{ $item['country']['title'] }}</a>@endif</td>
                    <td>@if($item['service']['id'])<a href="{{ url('/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/service/' . $item['service']['id'] .'/edit') }}" target="_blank">#{{ $item['service']['id'] }}-{{ $item['service']['title'] }}</a>@endif</td>
