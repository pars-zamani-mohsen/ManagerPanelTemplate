                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="row justify-content-end">
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 text-end">
                                            <select name="modulenamelist" id="modulenamelist" class="choices form-select" onchange="redirect()">
                                                <option value="">انتخاب کنید</option>
                                                @foreach($modulenamelist as $key => $item)
                                                    <option value="{{ $key }}" @if($s_modulename == $key) selected @endif>{{ $item }} ({{ $key }})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
