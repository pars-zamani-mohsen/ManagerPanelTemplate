...
@section('content')
    <div class="page-heading">
            ...
            <div class="row pb-3">
                ...
                <div class="row col-12 col-md-6 order-md-2 order-first pb-md-0 pb-3">
                    ...
                    <div class="col-12 text-end">
                        ...
                        <a href="{{ url('/'. App\Http\Controllers\HomeController::fetch_manager_pre_url() .'/' . $modulename['en']) }}" class="btn btn-outline-primary col-xxl-3 col-lg-6 col-md-6 col-12">
        ...
        @php if(isset($This) && $This) $operation = 'show'; @endphp
